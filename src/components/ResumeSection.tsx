  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto w-full">
        <h2 className="gradient-text text-4xl md:text-5xl font-bold mb-12 text-center">Resume</h2>
        <div className="glass-card p-8 flex flex-col items-center">
          ...
          <a
            ...
            className="neu-btn mt-8 shadow-soft-glow font-semibold text-lg py-4 px-8"
          >
            Download Resume
          </a>
        </div>
