        ...
        >
          {projects.map((project, index) => (
            <div key={project.id} className="flex-shrink-0">
              {/* Unified Project Card with Fixed Size */}
              <div className="neu-card p-6 backdrop-blur-md bg-gray-800/90 w-[400px] h-[600px] flex flex-col">
                {/* Project Case at the top - Fixed Height */}
                <div className="flex-shrink-0 mb-6 h-[280px] flex items-center justify-center">
