  ...
  return (
    ...
    >
      ...
      <div className="relative h-full flex items-center pt-20">
        ...
        <div
          ref={trackRef}
          className="flex items-stretch gap-8 px-12 min-w-max case-track"
        >
          {projects.map((project, index) => (
            <div key={project.id} className="flex-shrink-0">
              {/* Unified Project Card with reduced padding and borders */}
              <div className="rounded-lg p-4 backdrop-blur-md bg-gray-800/90 border border-white/5 w-[460px] h-[660px] flex flex-col shadow-lg">
                {/* Project Case at the top - Fixed Height */}
                <div className="flex-shrink-0 mb-4 h-[300px] flex items-center justify-center">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <p className="text-white/80 mb-4 leading-relaxed text-sm flex-1 line-clamp-4">
                    {project.description}
                  </p>
                  ...
                  <div className="flex gap-2 flex-shrink-0">
                    <a
                      ...
                      className="bg-blue-glow hover:bg-blue-400 text-white font-semibold px-3 py-2 rounded-lg flex items-center gap-2 transition-all text-xs flex-1 justify-center"
                    >
                    ...
                    <a
                      ...
                      className="bg-gray-700 hover:bg-gray-600 text-white font-semibold px-3 py-2 rounded-lg flex items-center gap-2 transition-all text-xs flex-1 justify-center"
                    >
