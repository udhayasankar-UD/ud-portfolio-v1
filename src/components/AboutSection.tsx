...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="w-full px-4 py-20 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900"
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-center md:items-start">
          <div className="relative mb-8">
            <img
              ...
              className="w-40 h-40 rounded-2xl shadow-neu object-cover border-4 border-gray-800"
            />
        ...
        {/* Right: About Me */}
        <div>
          <h2 className="gradient-text text-3xl md:text-4xl font-bold mb-4">About Me</h2>
